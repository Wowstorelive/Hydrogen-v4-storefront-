...
export const MultiRangeSlider = ({
  ...
  const {currencyCode} = useRouteLoaderData<RootLoader>('root');
    ...
    <div className="flex flex-col items-center">
      <div className="relative flex h-10 w-full items-center justify-center pb-4">
        ...
        <div className="relative w-full">
          <div className="absolute z-[1] h-2 w-full rounded-lg bg-gray-200"></div>
          <div
            ref={range}
            className="absolute z-[2] h-2 rounded-lg bg-black"
          ></div>
